...
export const listWeightMeasurementsTool: MueTool = {
  ...
  description: [
    ...
    "",
    "Every measurement carries its provenance, its server revision and its dates, plus the",
    "impedance the scale measured and the body composition estimated from it when there is one.",
    "Both are null on a weight typed by hand, and on a scale weighing whose profile was not",
    "complete enough to estimate from -- ordinary states, not failures. Which scale took the",
    "reading is never reported.",
    "",
    "The page also carries `lastAndroidSyncAt`, the last time the phone synchronised: readings",
    "the person took after that instant are not here yet.",
  ].join("\n"),
  inputSchema,
